 ...
 * @details  : Ported from M600 HAL. ADC1 channels: PA0,1,5,6,7 / PB0,1 / PC3,4.
...
/* M600 ADC channels (ADC1): PA0(0), PA1(1), PA5(5), PA6(6), PA7(7), PB0(8), PB1(9), PC3(13), PC4(14) */
typedef enum {
    BSP_ADC_CH_RF_I = 0,       /* ADC1_IN0  PA0 */
    BSP_ADC_CH_US_I,           /* ADC1_IN1  PA1 */
    BSP_ADC_CH_Heat_REF01,     /* ADC1_IN5  PA5 */
    BSP_ADC_CH_Heat_REF02,     /* ADC1_IN6  PA6 */
...
#define BSP_ADC_SAMPLE_TIME   ADC_SampleTime_7Cycles5
...
/* Sample a single logical channel (software-triggered, blocking). */
