 ...
 * Note: lib_aiic and hardware I2C both use 7-bit device address.
 */
#define DRV_24C02_DEV_ADDR_8BIT    0xA0  /* Legacy 8-bit address (not used by current implementation) */
#define DRV_24C02_DEV_ADDR_7BIT    0x50  /* 7-bit address */
 ...
 * @note For software I2C, this function initializes lib_aiic GPIO for AT24C02
...
/**
 * @brief Write multiple bytes to 24C02 (page-aware, user need not care about pages)
 ...
 * @return true if write successful, false otherwise
 * @note Driver automatically splits writes by 8-byte page boundaries internally.
 */
