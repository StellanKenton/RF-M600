...
typedef enum
{
    E_ADC_CHANNEL_0 = 0,          ///< ADC1_IN0  - PA0
    E_ADC_CHANNEL_1,              ///< ADC1_IN1  - PA1
    E_ADC_CHANNEL_8,              ///< ADC1_IN8  - PB0
    E_ADC_CHANNEL_9,              ///< ADC1_IN9  - PB1
    E_ADC_CHANNEL_12,             ///< ADC1_IN12 - PC2
    E_ADC_CHANNEL_13,             ///< ADC1_IN13 - PC3
